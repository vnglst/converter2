...
function Footer() {
  return (
    <div className="Footer">
      <p>
        The Word to Line Rates Converter calculates word to line prices. A standard line (a German "Normzeile") is assumed to be 55 characters including spaces. The converter also converts per line to per word prices.</p>
